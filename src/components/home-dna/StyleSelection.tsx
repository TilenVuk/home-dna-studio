...
export function StyleSelection({
  ...
  const copy =
    locale === "hr"
      ? {
          headline: "Koji biste stil mogli zamisliti u odabranim prostorima i za 15 godina?",
          support:
            "Možete odabrati najviše dva stila. Njihovu ćemo kombinaciju povezati u osobni stilski profil.",
          limit: "Možete odabrati najviše dva stila.",
        }
      : locale === "en"
        ? {
            headline: "Which style could you imagine in the selected spaces 15 years from now?",
            support:
              "You can choose up to two styles. We will combine them into a personal style profile.",
            limit: "You can select up to two styles.",
          }
        : {
            headline: "Kateri slog bi si predstavljali v izbranih prostorih tudi čez 15 let?",
            support:
              "Izberete lahko največ dva sloga. Njuno kombinacijo bomo povezali v osebni slogovni profil.",
            limit: "Izberete lahko največ dva sloga.",
          };

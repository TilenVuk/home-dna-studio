...
export function AiSearchQuestions() {
  return (
    <section id="vsebine" className="border-t border-border bg-background">
      <div className="mx-auto max-w-[1400px] px-6 py-28 md:px-10 md:py-40">
        <div className="max-w-3xl">
          <p className="eyebrow">Nuveli Studio · Vsebine</p>
          <h2 className="display-lg mt-6">
            Vprašanja, ki si jih zastavi skoraj vsak pri opremljanju doma
          </h2>
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground">
            Kratki, konkretni odgovori o načrtovanju interierja, pohištvu po meri, materialih,
            investiciji in Home DNA™ metodologiji.
          </p>
        </div>
